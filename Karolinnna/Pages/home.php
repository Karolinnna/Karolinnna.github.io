...
<head>
    ...
    <link rel="icon" href="/Karolinnna.github.io/Photo/logo.png" type="image/x-icon">
...
<body class="">
    <header class="">
        ...
        <nav>
            <a href="#"><img src="/Karolinnna.github.io/Photo/logo.png" alt="Loopi" class="main_logo" width="70" height="70" style="top: 0;"></a>
            <div class="searchBox" role="search">
                <input class="searchInput" type="text" placeholder="Search">
                <button class="searchButton" aria-label="Search button">
                    <img src="/Karolinnna.github.io/Photo/searchbar.png" alt="Search" style="height: 10px; width: 10px;">
                </button>
            </div>
    ...
    <main class="main">
        ...
        <section class="recommend" aria-label="Recommendations">
            <section class="trendsongs" aria-labelledby="trend-title">
                ...
                <div class="responsive">
                    <div class="gallery">
                        ...
                        <!--<img src="/Karolinnna.github.io/Photo/BirdOfPray.jpg" alt="BirdOfPray">-->
                        <div class="desc">
                ...
                <div class="responsive">
                    <div class="gallery">
                        ...
                        <!--<img src="/Karolinnna.github.io/Photo/Lighter.jpg" alt="Lighter">-->
                        <div class="desc">
                            <p><b>Lighter</b></p>
                            <p>Kyle</p>
                        </div>
                ...
                <div class="responsive">
                    <div class="gallery">
                        ...
                        <!--<img src="/Karolinnna.github.io/Photo/TheCode.png" alt="TheCode">-->
                        <div class="desc">
                            <p><b>The Code</b></p>
                            <p>Nemo</p>
                        </div>
                ...
                <div class="responsive">
                    <div class="gallery">
                        ...
                        <!--<img src="/Karolinnna.github.io/Photo/MySea.jfif" alt="MySea">-->
                        <div class="desc">
                            <p><b>My Sea</b></p>
                            <p>Molodi</p>
                        </div>
                ...
                <div class="responsive">
                    <div class="gallery">
                        ...
                        <!--<img src="/Karolinnna.github.io/Photo/WhatTheHellJustHappend.jpg" alt="WhatTheHell">-->
                        <div class="desc">
            ...
            <section class="popularsingers" aria-labelledby="popular-artists-title">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/LadyGaga.webp" alt="LadyGaga">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/Ziferblat.jfif" alt="Ziferblat">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/JeryHeil.jpg" alt="JeryHeil">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/Molodi.jfif" alt="Molodi">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/Ado.jpg" alt="Ado">
            ...
            <section class="featuredcharts" aria-labelledby="featured-charts-title">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/TopSongsGlobal.jpg" alt="TopSongsGlobal">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/TopSongsUkraine.jpg" alt="TopSongsUkraine">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/Top50SongsGlobal.jpg" alt="Top50Global">
                ...
                <div class="responsive">
                    <div class="gallery">
                        <img src="/Karolinnna.github.io/Photo/Top50SongsUkraine.jpg" alt="Top50Ukraine">
